...
[**ggrepel**](https://ggrepel.slowkow.com/) ![](image3.jpg){width="50px"} is an extension of **ggplot2** package which provides `geoms` for **ggplot2** to repel overlapping text as in our examples on the right. ![](image2.jpg){width="1000px"}
...
Finally, we will draw a scatterplot for English score versus Maths score by as shown below
