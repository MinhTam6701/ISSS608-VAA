...
[ggiraph](https://davidgohel.github.io/ggiraph/index.html) ![](image1.jpg){width="50px"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
## 3.5 Interactivity (show student's ID)
...
## 3.6 Interactivity (show student's ID and class)
...
Now we can see that the background colour of the tooltip is black and the font colour is white and bold.
