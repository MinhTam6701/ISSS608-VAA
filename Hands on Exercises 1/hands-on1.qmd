...
By then end of this chapter you will be able to apply the essential graphical elements provided by **ggplot2** to create elegant and yet functional statistical graphics.
...
::: callout-note
The code chunk bellow assumes that you might not have [`pacman`](https://cran.r-project.org/package=pacman) package installed. If have, please go ahead with second line only.
:::
...
![](image1.jpg){width="80px"} is an R package for **declaratively** creating data-driven graphics based on ***The Grammar of Graphics*** ![](image5.png){width="1000px"}

It is also part of the tidyverse family specially designed for visual exploration and communication. ![](image2.png){width="1000px"}
...
::: {style="text-align: center; font-size: 1.5em; padding: 20px 0;"}
...
ggplot2 is an implementation of Leland Wilkinson’s Grammar of Graphics. Figure below shows the seven grammars of ggplot2. ![](image4.jpg){width="1000px"}
...
::: {style="display: block; border: 1px solid #eee; padding: 10px; background-color: #fcfcfc; overflow-x: auto; white-space: nowrap;"}
